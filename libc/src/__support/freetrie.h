...
public:
  ...
  LIBC_INLINE constexpr FreeTrie() = default;
  ...
  /// nullptr.
  Node *find_best_fit(size_t size, SizeRange range);
...
LIBC_INLINE FreeTrie::Node *FreeTrie::find_best_fit(size_t size, SizeRange range) {
